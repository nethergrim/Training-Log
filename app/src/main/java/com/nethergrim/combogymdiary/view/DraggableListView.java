...
/**
 * Created by andrey_drobyazko on 20.08.14.
 */
public class DraggableListView extends ListView {
    ...
    private OnListItemSwapListener listener;

    public interface OnListItemSwapListener{
        public void onListItemSwapped(int i1, int i2);
    }

    public void setListener(OnListItemSwapListener swapListener){
        this.listener = swapListener;
    }
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            if (listener != null){
                listener.onListItemSwapped(originalItem, getPositionForView(switchView));
            } else {
                Log.e(this.getClass().getName(), "set OnListItemSwapListener to this listview!!");
            }
